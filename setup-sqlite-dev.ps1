# 🗄️ WEM Dashboard - Enhanced SQLite Development Setup (Windows)
...
Write-Host "🗄️ WEM Dashboard SQLite Development Setup" -ForegroundColor $Blue
...
Write-Host ""
Write-Host "1. 🖥️  Start the Backend (in Command Prompt 1):" -ForegroundColor $Blue
...
Write-Host "   👁️  Viewer:   viewer@wemdashboard.com   / Viewer123!" -ForegroundColor $Green
...
Write-Host ""
Write-Host "🗄️ SQLite Database Details:" -ForegroundColor $Green
...
Write-Host "   🛠️  Reset: Delete .db file and re-run this script" -ForegroundColor $Blue
Write-Host ""
...
Write-Host "   ❤️  Health Check:   http://localhost:5000/health" -ForegroundColor $Blue
Write-Host ""
