...
import { Zap, Lock, Mail, Eye, EyeOff, Leaf } from "lucide-react";
          ...
          <CardFooter className="flex flex-col space-y-4">
            ...
            <div className="text-center space-y-2">
              <p className="text-sm text-slate-400">
                Demo credentials: <span className="text-emerald-400 font-mono">admin@energyos.com</span> / <span className="text-emerald-400 font-mono">password</span>
              </p>
