    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        <div className="animate-slide-in-left">
          <h1 className="text-3xl font-bold text-white">{site.name} - Dashboard</h1>
          <p className="text-slate-400 mt-1">{site.location} • {site.region}</p>
        </div>
        <div className="flex items-center space-x-2 bg-green-500/10 border border-green-500/20 rounded-lg px-4 py-2 animate-pulse">
          <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
          <span className="text-green-400 font-medium">{site.status}</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {metrics.map((metric, index) => (
          <Card 
            key={index} 
            className="bg-slate-900/50 border-slate-700 hover:bg-slate-800/50 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-green-500/10 animate-fade-in"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="lg:col-span-2 bg-slate-900/50 border-slate-700 hover:border-slate-600 transition-all duration-300 animate-scale-in">
          <CardHeader>
        ...
        {/* Energy Mix */}
        <Card className="bg-slate-900/50 border-slate-700 hover:border-slate-600 transition-all duration-300 animate-scale-in">
          <CardHeader>
      ...
      {/* Recent Alerts */}
      <Card className="bg-slate-900/50 border-slate-700 hover:border-slate-600 transition-all duration-300 animate-slide-in-up">
        <CardHeader>
